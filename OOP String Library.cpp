...
int main() {
    ...
    cout << "Number of words: " <<
        clsString::CountWords("Ali Saleh Ibrahim") << endl;
    ...
    cout << "Capital Letters count : "
        << clsString::CountLetters("Ali Saleh Ibrahim", clsString::CapitalLetters)
        << endl << endl;

    //----------------

    String3.Value = "Welcome to Palestine";
    cout << String3.Value << endl;
    ...
    String3.Value = "Ali Saleh Ibrahim";
    cout << "\n\nString     = " << String3.Value;
    ...
    String3.Value = "Ali Saleh Ibrahim";
    cout << "\nReplace : " << String3.ReplaceWord("Ali", "Omar")
        << endl;
